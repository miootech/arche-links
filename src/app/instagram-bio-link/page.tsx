...
const faqLd = {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "Wie füge ich den Link in Instagram ein?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Kopiere deine arche.links URL → Instagram-Profil → Profil bearbeiten → unter „Website\" einfügen → speichern."
      }
    },
    {
      "@type": "Question",
      "name": "Kann ich die Farben an mein Instagram-Branding anpassen?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Ja, vollständig mobil-optimiert. Die erstellte Seite funktioniert perfekt auf iOS und Android und lädt schnell im Mobilnetz."
      }
    }
  ]
};
...
const breadcrumbLd = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://arche-links.pages.dev/instagram-bio-link"
    }
  ]
};
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-8">
          <div>
            ...
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
              Instagram erlaubt nur einen einzigen Link in deiner Bio. Mit einer Link-in-Bio Seite von arche.links bündelst du alle deine Links an einem Ort – kostenlos, ohne Anmeldung und ohne Wasserzeichen. Perfekt für Creator, Kleinunternehmen und Marken, die ihre Instagram-Präsenz professionell verlinken wollen.
            </p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold tracking-tight">Warum brauchst du einen Instagram Bio Link?</h2>
            <p className="text-muted-foreground leading-relaxed">
              Instagram erlaubt nur einen einzigen klickbaren Link im Profil – unter „Website" in deinem Instagram-Profil. Wenn du mehrere Links teilen willst (neuester Reel, YouTube-Video, Shop-Link, Newsletter-Anmeldung), musst du ständig den Bio-Link wechseln. Ein Instagram Bio Link löst dieses Problem, indem er alle deine wichtigen Links auf einer einzigen Seite bündelt. Du änderst den Link in deiner Instagram-Bio nur einmal und kannst danach alle Ziel-URLs zentral aktualisieren.
            </p>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="space-y-4">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="divide-y divide-border"><tr><td className="py-3 px-4">Anzahl Links</td><td className="text-center py-3 px-4 text-success">Unbegrenzt</td><td className="text-center py-3 px-4 text-destructive">5</td></tr><tr><td className="py-3 px-4">Anmeldung</td><td className="text-center py-3 px-4 text-success">Nicht nötig</td><td className="text-center py-3 px-4 text-destructive">Erforderlich</td></tr><tr><td className="py-3 px-4">Themes</td><td className="text-center py-3 px-4 text-foreground">8 + eigene Farben</td><td className="text-center py-3 px-4 text-destructive">Wenige</td></tr><tr><td className="py-3 px-4">Social Icons</td><td className="text-center py-3 px-4 text-foreground">13 Plattformen</td><td className="text-center py-3 px-4 text-destructive">Begrenzt</td></tr><tr><td className="py-3 px-4">HTML Export</td><td className="text-center py-3 px-4 text-success">Ja</td><td className="text-center py-3 px-4 text-destructive">Nein</td></tr><tr><td className="py-3 px-4">Wasserzeichen</td><td className="text-center py-3 px-4 text-success">Keins</td><td className="text-center py-3 px-4 text-muted-foreground">Linktree-Branding</td></tr><tr><td className="py-3 px-4">Instagram-optimiert</td><td className="text-center py-3 px-4 text-success">Ja</td><td className="text-center py-3 px-4 text-muted-foreground">Ja</td></tr></tbody>
              </table>
            </div>
          </section>

          <section className="space-y-4">
            <h2 className="text-2xl font-semibold tracking-tight">So erstellst du deinen Instagram Bio Link</h2>
            <p className="text-muted-foreground leading-relaxed">
              Die Erstellung deines Instagram Bio Links mit arche.links dauert weniger als eine Minute. Du brauchst keine Anmeldung und kannst sofort loslegen.
            </p>
            <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
              <li>Öffne <a href="https://arche-links.pages.dev/" className="text-amber-accent hover:underline">arche.links</a> – keine Anmeldung nötig</li><li>Trage deinen Instagram-Namen und eine kurze Bio ein</li><li>Lade optional dein Instagram-Profilbild hoch</li><li>Füge Links zu deinen neuesten Reels, Posts und Story-Highlights hinzu</li><li>Verlinke auf Shop, YouTube-Kanal, Newsletter oder TikTok-Profil</li><li>Wähle ein Theme passend zu deinem Instagram-Branding</li><li>Kopiere deine arche.links URL und füge sie unter Instagram → Profil bearbeiten → Website ein</li>
            </ol>
          </section>

          <section className="space-y-4">
            <h2 className="text-2xl font-semibold tracking-tight">Features von arche.links für Instagram</h2>
            <div className="grid sm:grid-cols-2 gap-3">
              <div className="rounded-xl bg-surface ring-1 ring-inset ring-border p-4">
                ...
                <p className="text-xs text-muted-foreground mt-1">Passe Farben exakt an dein Instagram-Branding an.</p>
              </div><div className="rounded-xl bg-surface ring-1 ring-inset ring-border p-4">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              <div><h3 className="font-semibold">Ist arche.links wirklich kostenlos?</h3><p className="text-muted-foreground text-sm mt-1">Ja, 100% kostenlos. Keine Credits, keine Limits, keine versteckten Kosten. Alle Features sind kostenlos nutzbar.</p></div><div><h3 className="font-semibold">Brauche ich ein Konto?</h3><p className="text-muted-foreground text-sm mt-1">Nein. Du erstellst deine Seite direkt im Browser und teilst den Link.</p></div><div><h3 className="font-semibold">Wie füge ich den Link in Instagram ein?</h3><p className="text-muted-foreground text-sm mt-1">Kopiere deine arche.links URL → Instagram-Profil → Profil bearbeiten → unter „Website" einfügen → speichern.</p></div><div><h3 className="font-semibold">Kann ich die Farben an mein Instagram-Branding anpassen?</h3><p className="text-muted-foreground text-sm mt-1">Ja. 8 Themes, 16 Color-Hunt-Paletten, eigene Hex-Farben, 5 Layouts und 13 Social Icons stehen zur Verfügung.</p></div><div><h3 className="font-semibold">Funktioniert arche.links auf dem Handy?</h3><p className="text-muted-foreground text-sm mt-1">Ja, vollständig mobil-optimiert. Die erstellte Seite funktioniert perfekt auf iOS und Android und lädt schnell im Mobilnetz.</p></div>
            </div>
          </section>
          ...
          <div className="flex flex-wrap gap-3 text-sm pb-8"><a href="https://arche-links.pages.dev/linktree-alternative" className="text-amber-accent hover:underline">Linktree Alternative</a> <span className="text-muted-foreground">·</span> <a href="https://arche-links.pages.dev/link-in-bio" className="text-amber-accent hover:underline">Link in Bio</a> <span className="text-muted-foreground">·</span> <a href="https://arche-links.pages.dev/tiktok-bio-link" className="text-amber-accent hover:underline">TikTok Bio Link</a> <span className="text-muted-foreground">·</span> <a href="https://arche-links.pages.dev/faq" className="text-amber-accent hover:underline">FAQ</a></div>
        </main>
      </div>
