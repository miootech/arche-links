...
const faqLd = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Ja. arche.links bietet 8 Themes, 16 Color-Hunt-Paletten, eigene Hex-Farben, 5 Layouts und Social Icons für Instagram, YouTube, TikTok und mehr."
      }
    },
    {
      "@type": "Question",
...
const breadcrumbLd = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://arche-links.pages.dev/linktree-alternative"
    }
  ]
};
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-8">
          <div>
            ...
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
              arche.links ist die kostenlose Alternative zu Linktree. Erstelle deine Link-in-Bio Seite mit unbegrenzten Links, eigenen Farben und Themes – ganz ohne Anmeldung und ohne Limits. Im Gegensatz zu Linktree, das im kostenlosen Plan auf 5 Links und wenige Themes beschränkt ist, bietet arche.links alle Features kostenlos.
            </p>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Linktree ist der bekannteste Link-in-Bio-Dienst, aber der kostenlose Plan ist stark eingeschränkt: Nur 5 Links, wenige Themes, kein eigenes Branding, keine detaillierte Anpassung, und ein Linktree-Wasserzeichen wird auf jeder Seite angezeigt. Wer professionell auftreten will, muss bei Linktree auf den Pro-Plan ($5/Monat) upgraden.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              arche.links schließt diese Lücke. Es ist eine komplett kostenlose Alternative, die alle Features bietet, die bei Linktree kostenpflichtig wären: unbegrenzte Links, eigene Farben und Themes, Social Icons, HTML-Export und kein Wasserzeichen. Zudem ist arche.links datenschutzfreundlicher – deine Link-Konfiguration wird client-seitig generiert, nicht auf einem Server gespeichert.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="divide-y divide-border"><tr><td className="py-3 px-4">Anzahl Links</td><td className="text-center py-3 px-4 text-success">Unbegrenzt</td><td className="text-center py-3 px-4 text-destructive">5</td></tr><tr><td className="py-3 px-4">Anmeldung</td><td className="text-center py-3 px-4 text-success">Nicht nötig</td><td className="text-center py-3 px-4 text-destructive">Erforderlich</td></tr><tr><td className="py-3 px-4">Themes</td><td className="text-center py-3 px-4 text-foreground">8 + eigene Farben</td><td className="text-center py-3 px-4 text-destructive">Wenige</td></tr><tr><td className="py-3 px-4">Social Icons</td><td className="text-center py-3 px-4 text-foreground">13 Plattformen</td><td className="text-center py-3 px-4 text-destructive">Begrenzt</td></tr><tr><td className="py-3 px-4">HTML Export</td><td className="text-center py-3 px-4 text-success">Ja</td><td className="text-center py-3 px-4 text-destructive">Nein</td></tr><tr><td className="py-3 px-4">Wasserzeichen</td><td className="text-center py-3 px-4 text-success">Keins</td><td className="text-center py-3 px-4 text-muted-foreground">Linktree-Branding</td></tr><tr><td className="py-3 px-4">Datenschutz</td><td className="text-center py-3 px-4 text-success">100% client-side</td><td className="text-center py-3 px-4 text-destructive">Server-basiert</td></tr><tr><td className="py-3 px-4">Preis</td><td className="text-center py-3 px-4 text-success">Kostenlos</td><td className="text-center py-3 px-4 text-muted-foreground">Free / Pro $5/mo</td></tr></tbody>
              </table>
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
              <li>Öffne <a href="https://arche-links.pages.dev/" className="text-amber-accent hover:underline">arche.links</a> – keine Anmeldung nötig</li><li>Trage deinen Namen und eine kurze Bio ein</li><li>Lade ein Profilbild hoch (optional)</li><li>Füge unbegrenzt Links hinzu – mit Icon, Titel und URL</li><li>Wähle ein Theme aus 8 Presets oder erstelle eigene Farben</li><li>Füge Social Icons hinzu (Instagram, YouTube, TikTok, GitHub, …)</li><li>Teile deine Seite per URL oder lade sie als standalone HTML herunter</li>
            </ol>
          </section>
          ...
          <div className="flex flex-wrap gap-3 text-sm pb-8"><a href="https://arche-links.pages.dev/link-in-bio" className="text-amber-accent hover:underline">Link in Bio</a> <span className="text-muted-foreground">·</span> <a href="https://arche-links.pages.dev/instagram-bio-link" className="text-amber-accent hover:underline">Instagram Bio Link</a> <span className="text-muted-foreground">·</span> <a href="https://arche-links.pages.dev/tiktok-bio-link" className="text-amber-accent hover:underline">TikTok Bio Link</a> <span className="text-muted-foreground">·</span> <a href="https://arche-links.pages.dev/faq" className="text-amber-accent hover:underline">FAQ</a></div>
        </main>
      </div>
